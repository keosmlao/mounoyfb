...
### ບໍ່ມີໂດເມນ — ໃຊ້ IP ໂດຍກົງ

```bash
sudo PORT=3002 bash deploy/install.sh
```

ແອັບຟັງ `0.0.0.0:3002` ເຂົ້າໄດ້ທີ່ `http://<IP ເຊີບເວີ>:3002`

> 🔴 **ບໍ່ມີ HTTPS = ລະຫັດຜ່ານຖືກສົ່ງແບບອ່ານໄດ້** ໃຜດັກກາງທາງກໍ່ເຫັນ.
> ຮັບໄດ້ຖ້າໃຊ້ໃນເຄືອຂ່າຍພາຍໃນ ແຕ່**ຢ່າໃຊ້ແບບນີ້ຜ່ານອິນເຕີເນັດດົນ** —
> ຫາໂດເມນມາແລ້ວແລ່ນ `sudo DOMAIN=... bash deploy/install.sh` ຈະໄດ້ HTTPS ຟຣີ
>
> ສະຄຣິບຕັ້ງ `COOKIE_SECURE=0` ໃຫ້ອັດຕະໂນມັດເມື່ອບໍ່ມີໂດເມນ —
> ຖ້າຕັ້ງເປັນ 1 ໂດຍບໍ່ມີ HTTPS ຈະ login ບໍ່ໄດ້ເລີຍ
